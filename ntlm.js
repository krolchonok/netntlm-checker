...
// A bare 48-hex string (no colons) is also accepted as a v1 NT response shorthand.
...
function checkPassword(line, password) {
  ...
  throw new Error(
    'Unrecognized hash format. Expected NetNTLMv1 (hashcat -m 5500): user::domain:LMresponse:NTresponse:challenge ' +
      '(or a bare 48-hex NT response), or NetNTLMv2 (hashcat -m 5600): user::domain:challenge:NTProofStr:blob'
  );
}
